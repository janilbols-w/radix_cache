...
class TreeNode:
    ...
    def __init__(self, id: Optional[int] = None, timestamp = None):
        self.children = defaultdict(TreeNode)
        self.parent = None
        self.key = None
        self.value = None
        self.lock_ref = 0
        self.create_time = timestamp if timestamp else time.time()
...
class RadixCache():
    ...
    def _split_node(self, key, child: TreeNode, split_len: int):
        # new_node -> child
        new_node = TreeNode(timestamp=child.create_time)
    ...
    def _print_helper(self, node: TreeNode, indent: int):
        ...
        while stack:
            ...
            print(
                ...
                "{:0.3f}".format(now - current_node.create_time),
            )
